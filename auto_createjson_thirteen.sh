  ...
  "response": [
    {
      ...
      "romtype": "RELEASE",
      "size":'$size',
      "url": "https://github.com/GADGETNiK/superior_ota_update/releases/download/'$nozip'/'$zip'",
      "version": "Thirteen",
...
gh release create $nozip --notes "Automated release SuperiorOS for $device $version $date/$time" $path/out/target/product/$device/$zip
